...
if __name__ == "__main__":
    ...
    print("First Name:", generator.firstName())  # e.g., "John"
    print("Last Name:", generator.lastName())  # e.g., "Doe"
    print("Indian Name:", generator.indianName())  # e.g., "राहुल राम"
    print("Foreign Name:", generator.foreignName())  # e.g., "Marie Martin"
    print("Location:", generator.location())  # e.g., "Antarctica"
    print("Address:", generator.address())  # e.g., "123 Main St, Springfield, IL"
    print("Indian Address:", generator.indianAddress())  # e.g., "मुंबई"
    print("Foreign Address:", generator.foreignAddress())  # e.g., "Paris, France"
    ...
    print("Random String:", generator.randomString(15))  # e.g., "aBcD1234eFgHiJkL"
